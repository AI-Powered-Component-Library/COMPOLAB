    ...
    return (
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[calc(100vh-120px)] px-6 py-10">
            ...
            <div className="inline-block mb-6 animate-fade-in">
                <div className="px-4 py-2 border border-cyan-500/30 rounded-full bg-cyan-950/20 backdrop-blur-md shadow-[0_0_20px_rgba(6,182,212,0.08)]">
                    <span className="text-cyan-400 text-xs sm:text-sm font-semibold tracking-wide flex items-center gap-2">
            ...
            <div className="text-center mb-6 max-w-4xl">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold mb-2 tracking-tight text-white leading-tight">
                    Build React UI
                </h1>
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold bg-gradient-to-r from-cyan-400 via-teal-400 to-indigo-400 bg-clip-text text-transparent tracking-tight leading-tight">
                    Faster with AI
                </h2>
            </div>
            ...
            {/* Code Block */}
            <div className="bg-slate-900/40 border border-slate-800 hover:border-cyan-500/20 rounded-2xl p-4.5 mb-8 backdrop-blur-md max-w-md w-full shadow-2xl transition-all duration-300 group/code relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full max-w-lg mb-4">
                ...
                <button 
                    ...
                    className="w-full sm:w-auto border border-slate-800 hover:border-cyan-400 hover:bg-cyan-400/5 text-white px-8 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center gap-2 transform hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
                >
