        ...
        <div className='header flex justify-between items-center px-4 py-3 border-b border-zinc-800'>
            ...
            <div id="center" className='flex gap-8 flex-3 justify-between items-center'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <button onClick={() => setIsWebBuilder(!isWebBuilder)} className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-300 ${isWebBuilder ? 'bg-blue-600' : 'bg-slate-600'} hover:shadow-lg hover:shadow-blue-500/30`}>
                        <span className={`inline-block h-5 w-5 transform rounded-full bg-white shadow-md transition-transform duration-300 ${isWebBuilder ? 'translate-x-5' : 'translate-x-0.5'}`} />
                    </button>
                </div>
